...
$app->get('/category-costs', function(ServerRequestInterface $request) use($app)
{
	...
	$categories = $repository->all();	//listando todas categorias
...
$app->get('/category-costs/{id}/edit', function(ServerRequestInterface $request) use($app)
{
	...
	$category = $repository->find($request->getAttribute('id')); //pegando a categ a ser editada de acordo com o id repassado
